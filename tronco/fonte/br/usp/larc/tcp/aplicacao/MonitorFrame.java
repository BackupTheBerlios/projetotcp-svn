...
public class MonitorFrame extends JFrame {
   ...
   /** Creates new form Monitor */
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jTextAreaPortaTCPNovaMaquina.setText("Porta TCP da nova máquina: ");
	...
	{	
    	public void run()
    	{
    		try 
			{
    			jTextAreaTabelaDeConexoes.setText(protocoloTCP.getMonitor().getTabelaDeConexoes().toString());
