 ...
 *  uma instância desse objeto para usá-lo. 
 *
 *  Um estudo sobre tipos primitivos de Java pode ajudar numa melhor compreensão
 *  dessa classe.
 *
...
public class Decoder {
	...
	/**
	 * Método que tem funcionalidade de converter uma String 
	 * com 16 caracteres (ex.: XXXxxxXXXxxxN) que representa um IP 
	...
	public static String ipSimuladoToBytePonto(String _oIPSimulado)
	{
		...
		for (int i = 0; i < 4; i++)
		{
			retornoIPSimulado = retornoIPSimulado + _oIPSimulado.substring(cursor, cursor + 3);
			cursor = cursor + 3;
			if (i != 3)
	...
	/**
	 * Método que tem funcionalidade de converter uma String no formato
	...
	public static String bytePontoToIpSimulado(String _bytePonto) {
        ...
        /**
	 * Método que tem funcionalidade de converter uma string num byte
         * (8 bits).
	 *
	 * @param  _palavra  A String que será convertida.
	 ...
	 *
	 * @param  _obyte  O byte que será convertido.
	...
	/**
	 * Método que converte um int (32 bits/4 bytes) em uma String de tamanho 
         * 2 (dois bytes). Usamos esse artifício para o campo porta do IPSimulado.
         *
	 * @param  _numero  O inteiro que será convertido.
	 * @return         A String de tamanho 2 convertida. Caso o parâmetro 
         * número seja menor que zero, retorna null.
         * 
         */
	 ...
	 * Método que converte uma String de dois caracteres (2 bytes) em um int.
         * 
	 * @param  _texto  A String que será convertida.
	...
	/**
	 * Método que coverte um short menor que 256 (usado para os campos de
         * do endereço IP) em um Caracter de 8 bits (1 byte) e retorna o valor
         * em String.
	 *
	 * @param  _numero  Número que se quer converter.
	 * @return         String com o valor do número convertido. Caso o valor
         * do número passado como parâmetro seja maior que 256, retorna null.   
	 */
	 ...
	 * @return         O short representando o valor de um caracter de 8 bits.
         * Caso a String passada com parâmetro tenha tamanho diferente de 1 (um)
         * retorna 0 (zero).
	 */
